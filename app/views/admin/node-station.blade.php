@forelse($stations as $station)
    <div id="station{{{$station->id}}}" class="conStation panel panel-default" style="margin-bottom:15px;">
        ...
        <div class="row">
            ...
            <div class="col-md-3 col-sm-4 col-xs-12 toolbar">
                <div class="btn-group pull-right" role="group" aria-label="...">
                    <button type="button" onclick="upsertSchedule(this)" data-id="" data-stationId="{{{$station->id}}}" class="btn btn-xs btn-default text-success" style="margin-right: 3px; font-weight: bold;"><i class="glyphicon glyphicon-plus"></i> Add Schedule</button>
        ...
        <div id="bodyStation{{{$station->id}}}" class="panel-collapse collapse" role="tabpanel" aria-labelledby="heading{{{$station->id}}}">
                ...
                <div id="schedule{{{$sched->id}}}" class="col-md-6" style="padding: 0 15px 15px 15px;">
                    ...
                    <div class="panel-body">
                        ...
                        <div class="btn-group" role="group" aria-label="..." style="position: absolute;top: 5px;right: 20px;">
                            <button type="button" onclick="upsertSchedule(this)" data-id="{{{$sched->id}}}" data-stationId="{{{$station->id}}}" class="btn btn-xs btn-default text-primary" style="margin-right: 3px"><i class="glyphicon glyphicon-pencil"></i></button>
                            <button type="button" onclick="remSchedule(this)"    data-id="{{{$sched->id}}}" data-stationId="{{{$station->id}}}" class="btn btn-xs btn-default text-danger"><i class="glyphicon glyphicon-remove"></i></button>
                        </div>
                    </div>
                    </div>
                </div>
